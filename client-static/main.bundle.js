    ...
    for (n = 0, len3 = ref4.length; n < len3; n++) {
      ...
      results.push((function() {
        ...
        for (o = 0, len4 = ref5.length; o < len4; o++) {
          sub = ref5[o];
          if (state.view.show_todo_sub && sub._id === state.view.show_todo_sub._id) {
            results1.push(state.view.show_todo_sub = sub);
          } else {
...
addPinForm = (function(superClass) {
  ...
  addPinForm.prototype.render = function(props, state) {
    ...
    if (this.state.type === 'photo') {
      ...
      check_submit = this.state.name && this.state.files && true || false;
    } else if (this.state.type === 'link') {
      title = 'pin a link';
      ctx = h('div', {
        className: 'pin-ctx'
...
PinsView = (function(superClass) {
  ...
  PinsView.prototype.componentWillRecieveProps = function(props) {
    return log(props.vuew.show_todo && props.view.show_todo._id, this.props.view.show_todo && this.props.view.show_todo._id);
  };
...
UserLoginView = (function(superClass) {
  ...
  UserLoginView.prototype.render = function() {
    console.log('RENDER', this.state.email, this.state.pass);
    return h(Slide, {
      vertical: true,
      auto: true,
      onEnter: this.login
